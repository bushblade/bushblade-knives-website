  ...
  <StaticQuery
    ...
    render={data => (
      ...
      >
        <NarrowContainer>
          <p>
            Since a small boy I have been running away to the woods to build
            dens and rope swings; some may say I've never grown up, but my rope
            swings have got a lot bigger and my 'dens' have become far more
            habitable, so certainly something has changed.
          </p>
          <p>
            I have always had a passion for wild places and spending time in
            them; bushcraft for me is a way of being comfortable and feeling at
            home in wild places.
          </p>
          <p>
            As a child the subject for me and my friends came under the heading
            of 'survival' and books by the likes of Lofty Wiseman and Eddie
            McGee were high on my Christmas list. However, survival implied a
            sense of 'how to get out of this alive', whereas I was in search of
            'how can I stay here longer?' When Ray Mears appeared on TV in the
            early 90's and brought the term bushcraft to my attention, that
            became my subject of study.
          </p>
          <p>
            ...
            I received a distinction. My learning accelerated from attending the
            course and later that year took a place on their Abo' course. Over
            the next few years I consolidated my learning with time spent in
            remote area's of England and Scotland as well as the Bahamas
            practicing the skills I had learned. In 2007 and 2008 I assisted the{' '}
            <a
              href="http://www.woodsmoke.uk.com/"
              target="_blank"
              rel="noopener noreferrer"
